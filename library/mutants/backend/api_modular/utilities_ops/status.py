...
def init_status_routes():
    ...
    @utilities_ops_status_bp.route("/api/operations/status/<operation_id>", methods=["GET"])
    @auth_if_enabled
    ...
    @utilities_ops_status_bp.route("/api/operations/cancel/<operation_id>", methods=["POST"])
    @admin_if_enabled
