...
def test_probe_stt_warmth_no_provider():
    ...
    from library.backend.api_modular import (
        streaming_translate as st,  # type: ignore[import-not-found]  # library.* only resolvable from project root; pytest adds it via conftest
    )
