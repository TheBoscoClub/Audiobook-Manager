...
class TestHelpPageStructure:
    ...
    def test_has_doctype(self):
        ...
        assert content.strip().startswith("<!DOCTYPE html>"), "help.html should start with DOCTYPE"

    def test_includes_theme_css(self):
        """help.html must reference the Art Deco theme stylesheet."""
        content = (WEB_DIR / "help.html").read_text()
        assert "theme-art-deco.css" in content, "help.html should include theme-art-deco.css"
    ...
    def test_start_tutorial_link(self):
        ...
        content = (WEB_DIR / "help.html").read_text()
        assert "index.html?tutorial=1" in content, "help.html should link to index.html?tutorial=1"
...
class TestHelpCSS:
    ...
    def test_uses_css_variables(self):
        ...
        assert "--deco-charcoal" in content, "help.css should use --deco-charcoal variable"
