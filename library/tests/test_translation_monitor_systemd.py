...
def test_live_monitor_timer_exists():
    timer = REPO / "systemd" / "audiobook-translation-monitor-live.timer"
    service = REPO / "systemd" / "audiobook-translation-monitor-live.service"
...
def test_sampler_monitor_timer_exists():
    timer = REPO / "systemd" / "audiobook-translation-monitor-sampler.timer"
    service = REPO / "systemd" / "audiobook-translation-monitor-sampler.service"
...
def test_live_monitor_startlimit_allows_30s_cadence():
    ...
    timer = _parse_unit(REPO / "systemd" / "audiobook-translation-monitor-live.timer")
    service = _parse_unit(REPO / "systemd" / "audiobook-translation-monitor-live.service")
...
def test_sampler_monitor_startlimit_allows_5min_cadence():
    ...
    timer = _parse_unit(REPO / "systemd" / "audiobook-translation-monitor-sampler.timer")
    service = _parse_unit(REPO / "systemd" / "audiobook-translation-monitor-sampler.service")
...
def test_neither_monitor_uses_zero_interval():
    ...
    for service_name in (
        ...
        unit = _parse_unit(REPO / "systemd" / service_name)
