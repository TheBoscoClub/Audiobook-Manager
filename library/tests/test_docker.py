...
class TestDockerBuild:
    ...
    def test_docker_image_has_correct_labels(self, docker_image):
        ...
        assert (
            "org.opencontainers.image.description" in labels
        ), "Missing OCI description label"
        assert (
            "org.opencontainers.image.licenses" in labels
...
class TestContainerLifecycle:
    ...
    def test_container_port_bindings(self, healthy_container):
        ...
        assert (
            healthy_container["http_port"] is not None
