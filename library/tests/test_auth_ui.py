...
class TestAuthCSS:
    ...
    def test_auth_css_links_in_html_pages(self):
        ...
        assert 'href="css/auth.css"' in register_content, (
    ...
    def test_help_tooltips_css_links_in_html_pages(self):
        ...
        assert 'href="css/help-tooltips.css"' in login_content, (
            "Login should include help-tooltips.css"
        )
        assert 'href="css/help-tooltips.css"' in register_content, (
...
class TestSecurityAttributes:
    ...
    def test_credentials_use_include(self):
        ...
        assert "credentials: 'include'" in login_content, (
            "Login should include credentials"
        )
        assert "credentials: 'include'" in library_js_content, (
