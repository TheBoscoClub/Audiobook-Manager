...
class LibraryTutorial {
        ...
        this.steps = [
            {
                ...
                title: 'Library Stats',
                description: 'These numbers show the total volumes, hours of audio, authors, and narrators in the collection. They update as you filter.',
            },
            {
                target: '#search-input',
                title: 'Search Bar',
                description: 'Type here to search by title, author, or narrator. Results filter instantly as you type.',
            },
            {
                target: '#author-autocomplete',
                title: 'Author Filter',
                description: 'Filter books by a specific author. Use the letter group buttons (A-E, F-J, etc.) to narrow the list, or type to search.',
            },
            {
                target: '#narrator-autocomplete',
                title: 'Narrator Filter',
                description: 'Same as the author filter, but for narrators. Book counts appear next to each name.',
            },
            {
                target: '#sort-filter',
                title: 'Sort Options',
                description: 'Choose how books are ordered: by title, author, narrator, duration, date acquired, publication year, series, or edition.',
            },
            {
            ...
            },
            {
                ...
                description: 'Some books have multiple editions (different narrators/formats) or supplemental material. Click the badge to expand and see all versions.',
                optional: true,
            },
            {
                target: '#audio-player',
            ...
            },
            {
                ...
                title: 'Help Button',
                description: 'You found it! Click this any time to come back to the User Guide or restart this tutorial.',
            },
        ];
        this.currentStep = 0;
        this.overlay = null;
    ...
    _buildTooltip(step, useFallback = false) {
        ...
        desc.textContent = useFallback && step.fallback ? step.fallback : step.description;
