...
const WebAuthn = {
  ...
  encodeRegistrationCredential(credential) {
    ...
    return {
      ...
      response: {
        clientDataJSON: this.bytesToBase64url(
          new Uint8Array(response.clientDataJSON),
        ),
        attestationObject: this.bytesToBase64url(
  ...
  encodeAuthenticationCredential(credential) {
    ...
    return {
      ...
      response: {
        ...
        authenticatorData: this.bytesToBase64url(
          new Uint8Array(response.authenticatorData),
        ),
        signature: this.bytesToBase64url(new Uint8Array(response.signature)),
        userHandle: response.userHandle
          ? this.bytesToBase64url(new Uint8Array(response.userHandle))
          : null,
      },
      authenticatorAttachment: credential.authenticatorAttachment,
      clientExtensionResults: credential.getClientExtensionResults(),
